...
public class FillDetailsActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void submitDetails() {
       ...
       // String _userUID = values[0];
        ...
        Log.v("USER","CURRENT USER : "+userEmail);
        String _userUID=FirebaseAuth.getInstance().getCurrentUser().getUid();
        ...
        final User user = new User(userId, userEmail, _firstName, _genderSelected, _lastName, _mobile, timestampChanged, timestampJoined);
