    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser()!=null){
                    startActivity(new Intent(GoogleSignInActivity.this,FillDetailsActivity.class));
                }

            }
        };

        mButtonGoogleSignin = (SignInButton) findViewById(R.id.activity_signin_btn_googlesignin);
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(getApplicationContext()).enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
            ...
            public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                Toast.makeText(GoogleSignInActivity.this, "you have an Error", Toast.LENGTH_LONG).show();
            }
