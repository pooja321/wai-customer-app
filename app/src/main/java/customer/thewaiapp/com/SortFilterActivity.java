...
public class SortFilterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sortfilter);
        ...
        mOkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveSettings();
                startActivity(new Intent(SortFilterActivity.this,MainActivity.class));
            }
        });
    ...
    private void saveSettings() {
        ...
        switch (id){
            case R.id.settings_rb_rating:
                Toast.makeText(SortFilterActivity.this, "You selected rating", Toast.LENGTH_SHORT).show();
                sortBy = Constants.SORTBY_RATING;
                break;
            case R.id.settings_rb_distance:
                Toast.makeText(SortFilterActivity.this, "You selected distance", Toast.LENGTH_SHORT).show();
